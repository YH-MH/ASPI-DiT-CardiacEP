...
from utils.misc import instantiate_from_config, check_attribute_or_method
...
def build_dataloader(config, args=None, return_dataset=False):
    ...
    dataload_info = {
        ...
        'inverse_factors': check_attribute_or_method(train_dataset, "inverse_transform_factors"),
        'inverse_apdatas': check_attribute_or_method(train_dataset, "inverse_transform_apdatas"),
        "factors_max": check_attribute_or_method(train_dataset, "factors_max"),
        "factors_min": check_attribute_or_method(train_dataset, "factors_min"),
    }
