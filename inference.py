...
from utils.misc import seed_everything, merge_opts_to_config, modify_config_for_debug
...
def get_args():
    parser = argparse.ArgumentParser(description='PyTorch Training scripts')
    parser.add_argument('--name', type=str, default='',
                        help='the name of this experiment, if not provided, set to'
                             'the name of config file')
    parser.add_argument('--config_file', type=str, default='configs/ord1_train.yaml',
    ...
    parser.add_argument('--num_generated', type=int, default=1,
                        help='Number of samples generated by single condition for validation or test phase')
    parser.add_argument('--tensorboard', action='store_true',
                        help='use tensorboard for logging')
    parser.add_argument('--data_phase', type=str, default=None,
                        help='adjusting the name of the subfile used for test')
    parser.add_argument('--batch_size', type=int, default=None,
                        help='Increase batch_size to speed up generation')
...
def main_worker(local_rank, args):
    ...
    # 更换yaml文件中的validation数据为目标test数据, 设置单一条件对应的生成数量
    config['dataloader']['validation_datasets'][0]['params']['phase'] = args.data_phase  # 设置新值
    # 提高batch_size 加速推理速度
    ...
    logger.log_info('model = {}'.format(model))
    if args.sync_bn:
